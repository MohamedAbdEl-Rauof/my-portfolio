                        ...
                        <motion.div variants={itemVariants}>
                            <Grid container mt={2} spacing={2}>
                                {[
                                    {
                                        icon: <GitHubIcon/>,
                                        link: "https://github.com/MohamedAbdEl-Rauof",
                                    },
                                    {
                                        icon: <LinkedInIcon/>,
                                        link: "https://www.linkedin.com/in/mohamed-abd-el-raouf-6b5b3b235/",
                                    },
                                    {icon: <EmailIcon/>, link: "mailto:mohamedabdelrauof112@gmail.com"},
                                    {
                                        icon: <InstagramIcon/>,
                                        link: "https://www.instagram.com/mohamed.abdelrauoff/",
                                    },
                                    {
                                        icon: <FacebookIcon/>,
                                        link: "https://www.facebook.com/profile.php?id=100040578035349",
                                    },
                                ].map((item, index) => (
                                    <Grid item key={index}>
                                        <motion.div
